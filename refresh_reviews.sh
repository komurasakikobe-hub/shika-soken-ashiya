#!/bin/zsh
# 芦屋歯科総研 — 評価・口コミ件数の月次リフレッシュ＋サイト再生成＋公開
...
git push
# 公開はshika-sokenリポジトリのashiyaブランチから行われる（Cloudflare Pages接続先）
git push https://github.com/komurasakikobe-hub/shika-soken.git main:ashiya
echo "===== 完了 $(date) ====="
