...
# ===== 芦屋歯科総研 ビジュアルシステム（SVG / 5色＋オレンジ・実写禁止）=====
...
def clean_title(t):
    """タイトルから冗長な『芦屋』を除去（サイト名=芦屋歯科総研で自明のため）"""
    t = re.sub(r"^【芦屋市?】\s*", "", t)
    t = t.replace("｜芦屋市版", "").replace("｜芦屋版", "")
    t = t.replace("芦屋で使える", "使える")
    t = t.replace("芦屋で知る", "")
    t = t.replace("芦屋のインプラント", "インプラント")
    t = t.replace("芦屋ホワイトニング", "ホワイトニング")
    t = t.replace("芦屋の", "").replace("芦屋で", "").replace("芦屋", "")
    t = re.sub(r"｜\s*(市版|版)", "", t)
...
def build():
    ...
    trend = pick(["芦屋のインプラント費用", "歯周病治療の専門性", "芦屋ホワイトニング",
                  "子どもの虫歯予防", "歯のクリーニング"])
...
FOOTER = '''<footer class="site-footer">
  <div class="wrap-x">
    ...
    <p class="foot-copy">© 芦屋歯科総研 ASHIYA DENTAL RESEARCH</p>
  </div>
</footer>
<script>
...
<title>歯科コラム | 芦屋歯科総研</title>
<meta name="description" content="症状や治療の基礎知識、歯科医院の選び方まで。芦屋で後悔しない歯科選びに役立つ情報をお届けします。">
<meta property="og:type" content="website">
<meta property="og:site_name" content="芦屋歯科総研">
<meta property="og:title" content="歯科コラム | 芦屋歯科総研">
<meta property="og:description" content="症状や治療の基礎知識、歯科医院の選び方まで。芦屋で後悔しない歯科選びに役立つ情報をお届けします。">
<meta property="og:url" content="https://ashiya.shikasoken.com/articles/index.html">
<link rel="canonical" href="https://ashiya.shikasoken.com/articles/index.html">
...
<section class="hero">
  <div class="wrap-x">
    <div class="hero-in">
      ...
      <p class="lead">正しい知識は、納得できる歯科医院選びにつながります。<br>芦屋歯科総研では、症状・治療・医院選びに役立つ情報を、<br>口コミや公開情報、AI分析の視点から整理しています。</p>
      <div class="search">
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width,initial-scale=1.0">
<title>{title} | 芦屋歯科総研 コラム</title>
<meta name="description" content="{title}に関する芦屋の歯科コラム記事一覧。">
<link rel="canonical" href="https://ashiya.shikasoken.com/articles/{href}">
''' + STYLE + '''
<script src="../assets/site-config.js"></script>
<script src="../assets/odr-track.js"></script>
</head>
